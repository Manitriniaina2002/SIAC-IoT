...
class TelemetrySensors(BaseModel):
    temperature: Optional[float]  # DHT22 temperature
    humidity: Optional[float]    # DHT22 humidity
    distance: Optional[float]    # Ultrasonic distance
    motion: Optional[bool]      # PIR motion detection (if any)
    servo_state: Optional[str]  # Servo state (if used)
