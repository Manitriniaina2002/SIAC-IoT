...
export default function Alerts(){
  ...
  const alerts = [
    {id: 1, device: 'esp32-001', severity: 'critical', message: 'Température anormale détectée', time: 'Il y a 5 min', score: 0.89},
    {id: 2, device: 'rpi-001', severity: 'medium', message: 'Trafic réseau inhabituel', time: 'Il y a 12 min', score: 0.72},
    {id: 3, device: 'esp32-002', severity: 'low', message: 'Connexion intermittente', time: 'Il y a 1h', score: 0.45},
    {id: 4, device: 'rpi-002', severity: 'critical', message: 'Échec d\'authentification répété', time: 'Il y a 2h', score: 0.95},
  ]
      ...
      <div className="space-y-6 relative" style={{zIndex: 10}}>
        ...
        >
          <ul style={{ marginTop: '1rem', lineHeight: '2', paddingLeft: '1.5rem' }}>
            <li>Vérifier les logs du device <code>esp32-001</code> pour la température</li>
            <li>Analyser le trafic réseau de <code>rpi-001</code></li>
            <li>Investiguer les échecs d'authentification répétés</li>
          </ul>
        </ContentCard>
      </div>
    </div>
